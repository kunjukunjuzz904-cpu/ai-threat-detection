...
import { C as useQueryClient, z as onlineManager } from "./modern-B8Zj8Aec.js";
import { I as lazy, R as mergeProps, S as createSignal, U as render, h as createComponent, q as setupStyleSheet } from "./Q7GRFEEB-CowQjoF2.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./VKXKX7EQ-D8Fqc50j.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./ZUJJ2RGI-DQCYoodb.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
